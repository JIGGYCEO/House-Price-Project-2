...
st.markdown("<h1 style = 'color: #0C356A; text-align: center; font-family: Times New Roman, Times, serif;'>HOUSE PRICE PREDICTION</h1>", unsafe_allow_html = True)
...
st.sidebar.image('pngwing.com (7).png', caption = f'Welcome {username}')
...
if st.button('Press To Predict'):
    ...
    st.image('pngwing.com (8).png', width = 200)
